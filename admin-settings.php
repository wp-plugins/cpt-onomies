...
class CPT_ONOMIES_ADMIN_SETTINGS {
	...
	public function get_plugin_options_help_tab_troubleshooting() {
        ...
        <ul>
      	...
      	<p>' . sprintf( __( 'I hope that version 1.1 fixed this bug but, if you\'re still having the problem, you can dequeue the validation script by placing the following code in your %s file:', CPT_ONOMIES_TEXTDOMAIN ), 'functions.php' ) . '</p>
